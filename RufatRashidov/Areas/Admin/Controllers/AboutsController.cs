...
namespace RufatRashidov.Areas.Admin.Controllers
{
    ...
    public class AboutsController : Controller
    {
        ...
        public AboutsController(DbPortfolio context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("WebArea,Title,ID,ModifiedOn")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WebArea,Title,ID,ModifiedOn")] About about)
        {
            if (id != about.ID)
            {
                return NotFound();
